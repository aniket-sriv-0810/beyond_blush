  ...
  return (
    <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
      <img
        src={imgSrc}
        alt="User"
        className="w-28 h-28 rounded-full object-cover border-2 border-orange-300 shadow-lg"
      />
      <div className="text-center sm:text-left space-y-1">
        <h2 className="text-2xl font-bold text-orange-700 md:pt-4">{user?.name}</h2>
